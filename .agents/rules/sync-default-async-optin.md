...
Doesn't mean async resolution is optional to implement or secondary in priority — see the functional scope in `.agents/docs/approach.md`, where it's a required capability, just not the implicit one.
